...
public class PendingReimbursementRequestsServlet extends HttpServlet {
...
protected void doGet(HttpServletRequest req, HttpServletResponse resp)
  ...
  if(accessLevel == null) {
    ...
    List<ReimbursementRequest> rrs = dao.findPendingReimbursementRequestsForEmployee(employee.getId());
    ...
    out.print(hu.createHtmlHeader("Pending Reimbursement Requests for " + employee.getFirstName() + " " + employee.getLastName()));
